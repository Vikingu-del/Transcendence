...
# Export variables
export DB_USER=$(echo $VAULT_RESPONSE | jq -r .data.data.DB_USER)
export DB_PASSWORD=$(echo $VAULT_RESPONSE | jq -r .data.data.DB_PASSWORD)
export DB_NAME=$(echo $VAULT_RESPONSE | jq -r .data.data.DB_NAME)
export DB_HOST=$(echo $VAULT_RESPONSE | jq -r .data.data.DB_HOST)
export DB_PORT=$(echo $VAULT_RESPONSE | jq -r .data.data.DB_PORT)
